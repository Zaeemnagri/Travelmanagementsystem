...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String []text = new String[]{"Dumani  Resort Nagar","Serena Hotel Gilgit","Four Season Hotel","Raddison Blue Hotel","Classio Hotel","Bay Club Hotel","Breeze Blow Hotel","Taj Hotel","Plaza Hotel","Dream Hotel"};
