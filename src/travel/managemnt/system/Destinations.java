...
public class Destinations extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String []text = new String[]{"JW Marriot Hotel","Madarin Oriental Hotel","Four Season Hotel","Raddison Blue Hotel","Classio Hotel","Bay Club Hotel","Breeze Blow Hotel","Taj Hotel","Mountain Hotel","River View Hotel"};
